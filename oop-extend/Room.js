...
Room.prototype.plan = function() {
    ...
    if (Game.colonize && Game.time % 100 == 0) {
        if (Game.manhattanDistance(this.name, Game.request_drones) <= 2 && Game.rooms[Game.colonize].my == false) {
    ...
    if (Game.request_drones && Game.time % 100 == 0) {
        if (Game.manhattanDistance(this.name, Game.request_drones) <= 2 && Game.rooms[Game.colonize].my == true) {
